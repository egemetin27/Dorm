...
const AuthProvider = ({ children }) => {
	...
	const [mySchoolCardTutorialDone, setMySchoolCardTutorialDone] = useState(true); // the bool which checks if the My School ad is needed when user is swiping other users' cards
	const [campusGhostCardTutorialDone, setCampusGhostCardTutorialDone] = useState(true); // the bool which checks if the Campus Ghost ad is needed when user is swiping other users' cards
