...
export default function Register({ navigation }) {
        ...
        () => [
            {
                ...
                alert: () => {
                    Alert.alert(
                        "Hata!",
                        "Adını ve soyadını yanlış girmiş olabilirsin",
                        [{ text: "Kontrol Edeyim" }]
                    );
                },
            },
            {
                ...
                alert: () => {
                    Alert.alert("Hata!", "18 Yaşından Büyük Olmalısın!", [
                        { text: "Kontrol Edeyim" },
                    ]);
                },
            },
            ...
            },
            {
                ...
                checkInput: (email) => {
                    if (
                        email.toLocaleLowerCase().trim().split("@")[1] !=
                        userInfo.School.mailExt
                    )
                        return false;
                    return true;
                },
                alert: () => {
                    Alert.alert(
                        "Hata!",
                        "Mail adresin ile seçtiğin üniversite eşleşmiyor!",
                        [{ text: "Kontrol Edeyim" }]
                    );
                },
            },
    ...
    const canGoForward = useMemo(() => {
        return INPUT_FIELDS[index].checkInput(
            userInfo[INPUT_FIELDS[index].databaseKey] ?? ""
        );
    ...
    const handleRegister = () => {
        ...
        const parsedDate =
            ...
            "-" +
            (Birth_date.getDate() < 10
                ? "0" + Birth_date.getDate()
                : Birth_date.getDate());
                ...
                <View style={{ flex: 1, alignItems: "flex-end" }}>
                    ...
                    >
                        <MaterialIcons
                            ...
                            size={27}
                            color={
                                canGoForward ? colors.black : colors.cool_gray
                            }
                        />
                    </Pressable>
                </View>
