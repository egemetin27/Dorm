...
export default function MainPage({ navigation }) {
    ...
    const [eventCard, setEventCard] = useState({
        ...
        questionTitle:
            "Etkinliklere birlikte gidecek kimseyi bulamamaktan sıkıldın mı?",
        description:
        ...
        >
            ...
            >
                ...
                <View
                    ...
                    style={[
                        commonStyles.Header,
                        { height: height * 0.05, marginTop: height * 0.01 },
                    ]}
                >
                    <Pressable
                        onPress={() => {
            ...
            <FlatList
                ...
                ListFooterComponent={() =>
                    shownEvents.length === 0 ? (
                        ...
                        >
                            Maalesef burada gösterebileceğimiz bir etkinlik
                            kalmamış...
                        </Text>
                    ) : null
                }
