        ...
        const stackready = async () => {
            ...
            async function prepare() {
                try {
                    ...
                    await AsyncStorage.getItem("Constants").then(
                        async (res) => {
                            ...
                            AsyncStorage.getItem("scrollNotShowed").then(
                                (res) => {
                                    if (res == null) {
                    ...
                    if (!isLoggedIn) {
                        const credsStr = await SecureStore.getItemAsync(
                            "credentials"
                        );
                        if (credsStr) {
            ...
            <Stack.Navigator mode={"modal"}>
                {updateNeeded ? (
                    ...
                    <Stack.Group screenOptions={{ headerShown: false }}>
                        ...
                        <Stack.Screen
                            name="MahremiyetPolitikasi"
                            component={MahremiyetPolitikasi}
                        />
                        <Stack.Screen
                        ...
                        />
                        <Stack.Screen
                            name="ToplulukKurallari"
                            component={ToplulukKurallari}
                        />
                    ...
                    <Stack.Group screenOptions={{ headerShown: false }}>
                        ...
                        <Stack.Screen
                            name="RMahremiyetPolitikasi"
                            component={RMahremiyetPolitikasi}
                        />
                        <Stack.Screen
                            name="RKullaniciSozlesmesi"
                            component={RKullaniciSozlesmesi}
                        />
